...
#if 1 /*woonhak, add innobase_doublewrite_file */
static char*  	innobase_doublewrite_file   = NULL;
static my_bool	innobase_use_streamid = FALSE;
#endif
	...
	void	*p)	/*!< in: InnoDB handlerton */
{
	...
	srv_use_streamid = (ibool) innobase_use_streamid;
#endif
...
#if 1 /*woonhak, add doublewrite_file */
...
static MYSQL_SYSVAR_BOOL(use_streamid, innobase_use_streamid,
  PLUGIN_VAR_NOCMDARG | PLUGIN_VAR_READONLY,
