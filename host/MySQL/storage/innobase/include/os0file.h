...
#if 1 /*woonhak, add MAXSTREAM*/
#define FADV_STREAMID_MAX_BIT 3
#define FADV_STREAMID_MAX 8
#endif
...
#if 1 /*woonhak, add this for streamSSD */
ibool
os_file_set_streamid(
/*===============*/
	const char*	name,	/*!< in: name of the file or path */
	os_file_t	file,   /*!< in, own: handle to a file */
	off_t streamid,			/*!< in, streamid */
	uint64_t file_size); 	/*total file size, NOT USED*/
#endif
/***********************************************************************//**
