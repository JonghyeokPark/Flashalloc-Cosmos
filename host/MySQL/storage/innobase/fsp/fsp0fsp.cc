...
#if 1 /*woonhak, to debug */
	if(space == TRX_DOUBLEWRITE_SPACE)
	{
		fprintf(stderr, "Create doublewrite fsp Header - block page no : %ld\n", buf_block_get_page_no(block));
	}
#endif
...
#if 1 /*woonhak, set doublewrite space id */
...
#if 1 /* woonhak */
	if(space == TRX_DOUBLEWRITE_SPACE)
		fprintf(stderr, "Create file seg for doublewrite buffer \n");
#endif
...
#if 0 /*woonhak */
	if(space == TRX_DOUBLEWRITE_SPACE)
		fprintf(stderr, "woonhak - %s:%d, size:%ld\n", __func__, __LINE__, size);
#endif
