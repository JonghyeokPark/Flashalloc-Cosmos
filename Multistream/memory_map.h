...
#include "probe/get_time_host_request.h"
#include "probe/performance_counter.h"
...
//#define TEMPORARY_DATA_BUFFER_BASE_ADDR                        (DATA_BUFFER_BASE_ADDR + AVAILABLE_DATA_BUFFER_ENTRY_COUNT * BYTES_PER_DATA_REGION_OF_SLICE_FOR_DATA_BUFFER)
//#define SPARE_DATA_BUFFER_BASE_ADDR                            (TEMPORARY_DATA_BUFFER_BASE_ADDR + AVAILABLE_TEMPORARY_DATA_BUFFER_ENTRY_COUNT * BYTES_PER_DATA_REGION_OF_SLICE_FOR_DATA_BUFFER)
//#define TEMPORARY_SPARE_DATA_BUFFER_BASE_ADDR  				   (SPARE_DATA_BUFFER_BASE_ADDR + AVAILABLE_DATA_BUFFER_ENTRY_COUNT * BYTES_PER_SPARE_REGION_OF_SLICE)
//#define RESERVED_DATA_BUFFER_BASE_ADDR                         (TEMPORARY_SPARE_DATA_BUFFER_BASE_ADDR + AVAILABLE_TEMPORARY_DATA_BUFFER_ENTRY_COUNT * BYTES_PER_SPARE_REGION_OF_SLICE)
...
#define HOST_REQUEST_TIME_TABLE_ADDR		(NVME_IO_CMD_COMPLETE_TABLE_ADDR + sizeof(NVME_IO_CMD_COMPLETE_TABLE))
#define PRINT_BUFFER_TABLE_ADDR 			(HOST_REQUEST_TIME_TABLE_ADDR + sizeof(HOST_REQUEST_TIME_TABLE))
#define PERFORMANCE_COUNTER_ADDR			(PRINT_BUFFER_TABLE_ADDR + sizeof(PRINT_BUFFER_TABLE))
