...
unsigned int AllocateDataBufMiss();
...
// (jhpark): add
unsigned int CheckDataBufHitForTRIM(unsigned int logicalSliceAddr);
unsigned int AllocateDataBufHitforTRIM(unsigned int logicalSliceAddr);
