...
//row -> page
#define	BYTES_PER_DATA_REGION_OF_PAGE			(16384)	//(4096)(16384)
...
#define	BYTES_PER_NVME_BLOCK		(4096)//Do not change
...
#define	USER_BLOCKS_PER_LUN		(4096/64)	//(4096/128) //(4096/32) 		//user configurable factor //MAX 4096
#define	USER_CHANNELS			(8) // (8) //(NUMBER_OF_CONNECTED_CHANNEL)		//user configurable factor
#define	USER_WAYS				(8)			//user configurable factor
// debug
//#define USER_BLOCK_START_NO 	256
//#define USER_BLOCKS_PER_LUN		USER_BLOCK_START_NO + (4096/32)  //(4096/64)		//user configurable factor //MAX 4096
//************************************************************************

#define	BYTES_PER_DATA_REGION_OF_SLICE		(BYTES_PER_DATA_REGION_OF_PAGE)					//Do not change	//slice is a mapping unit of FTL
#define	BYTES_PER_SPARE_REGION_OF_SLICE		(256)											//Do not change
...
#define	SLICES_PER_BLOCK			(USER_PAGES_PER_BLOCK * SLICES_PER_PAGE) //128*(slice/page)
...
#define	USER_BLOCKS_PER_SSD			(USER_BLOCKS_PER_CHANNEL * USER_CHANNELS) //user block*8*8*2

//#define	MB_PER_BLOCK					((BYTES_PER_DATA_REGION_OF_SLICE * SLICES_PER_BLOCK) / (1024 * 1024))
//#define	B_PER_BLOCK						(BYTES_PER_DATA_REGION_OF_SLICE * SLICES_PER_BLOCK)
